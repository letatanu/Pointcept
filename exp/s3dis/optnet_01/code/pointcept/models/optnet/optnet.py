...
- ICPR-style self-supervised ordering loss (KNN locality + distribution).
"""
...
class PointSorter(nn.Module):
    ...
    ICPR-style: takes Point object, detaches features for self-supervision.
    """
    ...
    def forward(self, point):
        # ICPR-style: concat coord + detached feature
