weight = 'exp/s3dis/optnet_01/model/model_best.pth'
resume = False
evaluate = True
test_only = False
seed = 52306032
save_path = 'exp/s3dis/optnet_01'
num_worker = 16
batch_size = 4
...
mix_prob = 0.8
param_dicts = [
    dict(keyword='sorter', lr=0.0006),
    dict(keyword='block', lr=0.0006)
]
hooks = [
