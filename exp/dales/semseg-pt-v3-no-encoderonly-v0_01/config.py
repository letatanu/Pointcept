weight = 'exp/dales/semseg-pt-v3-no-encoderonly-v0_01/model/model_best.pth'
resume = False
evaluate = True
test_only = False
seed = 38090633
save_path = 'exp/dales/semseg-pt-v3-no-encoderonly-v0_01'
num_worker = 24
batch_size = 21
...
ignore_index = -1
names = [
    'Ground', 'Vegetation', 'Cars', 'Trucks', 'Power lines', 'Fences', 'Poles',
    'Buildings'
]
grid_size = 0.5
model = dict(
