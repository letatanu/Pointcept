...
echo "Checking if this directory exists: $EXP_DIR"
echo "DEBUG: Initial RESUME value from getopts is: $RESUME"
if [ -d "$EXP_DIR" ]; then
    echo "Result: Yes, the script sees the directory!"
else
    echo "Result: No, the script CANNOT see the directory."
fi
echo "======================="
