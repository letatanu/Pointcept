weight = 'exp/aerorelief3d/semseg-pt-v3m1-0-base/model/model_best.pth'
resume = False
evaluate = True
test_only = False
seed = 16718350
save_path = 'exp/aerorelief3d/semseg-pt-v3m1-0-base'
num_worker = 16
batch_size = 16
...
wandb_key = None
mix_prob = 0.8
param_dicts = [dict(keyword='block', lr=6e-05)]
hooks = [
